...
bool	W25qxx_Init(void)
{
  ...
  HAL_GPIO_WritePin(_W25QXX_CS_GPIO,_W25QXX_CS_PIN,GPIO_PIN_SET);
	...
	w25qxx.PageSize=256;
	w25qxx.SectorSize=0x1000;  // 4096 4K  = 16 pages
	w25qxx.SectorCount=w25qxx.BlockCount*16;  // = 256 sectors
	w25qxx.PageCount=(w25qxx.SectorCount*w25qxx.SectorSize)/w25qxx.PageSize; // 4096 pages
	w25qxx.BlockSize=w25qxx.SectorSize*16;  // 65536
